...
export class InteractionManager {
  ...
  private removeIfInTrash(visual: Visual | null) {
    ...
    if (!trash || !canvas) return;

    const trashRect = trash.getBoundingClientRect();
    const canvasRect = canvas.getBoundingClientRect();

    // Translate trash bounding box into canvas-relative coordinates
    const rect = {
      left: trashRect.left - canvasRect.left,
      right: trashRect.right - canvasRect.left,
      top: trashRect.top - canvasRect.top,
      bottom: trashRect.bottom - canvasRect.top,
    };
